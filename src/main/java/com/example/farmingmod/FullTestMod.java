...
public class FullTestMod {
    ...
    public void modeSwitch(String mode) {
        ...
        if(mode.equalsIgnoreCase("mushroom")){
            mc.thePlayer.addChatMessage(new ChatComponentText(
                    "yaw : -106 ,pitch : 5.5"
            ));
        }
    ...
    public void mushroomFarming(){
        ...
        if(mc.thePlayer.posY >= 70.875 || mc.thePlayer.posY <= 71){
        }
        else {
            phase = 5;
            if (tickCounter == 200)
